...
public static class Sql
{
	...
	/// </summary>
	public static SqlSource And(params IEnumerable<SqlSource> sqls) => new AndOperatorSql(sqls.AsReadOnlyList());
	...
	/// </summary>
	public static SqlSource GroupBy(params IEnumerable<SqlSource> sqls) => new GroupByClauseSql(Join(", ", sqls));

	/// <summary>
	/// Creates SQL for a HAVING clause. If the SQL is empty, the HAVING clause is omitted.
	/// </summary>
	public static SqlSource Having(SqlSource sql) => new HavingClauseSql(sql);
	...
	public static SqlSource LikeParamStartsWith(string prefix) => new LikeParamStartsWithSql(prefix ?? throw new ArgumentNullException(nameof(prefix)));
	...
	/// </summary>
	public static SqlSource Name(string identifier) => new NameSql(identifier ?? throw new ArgumentNullException(nameof(identifier)));

	/// <summary>
	/// Joins the specified SQL fragments with the OR operator.
	/// </summary>
	public static SqlSource Or(params IEnumerable<SqlSource> sqls) => new OrOperatorSql(sqls.AsReadOnlyList());

	/// <summary>
	/// Creates SQL for an ORDER BY clause. If the SQLs are empty, the ORDER BY clause is omitted.
	/// </summary>
	public static SqlSource OrderBy(params IEnumerable<SqlSource> sqls) => new OrderByClauseSql(Join(", ", sqls));
	...
	/// </summary>
	public static SqlSource Raw(string text) => new RawSql(text ?? throw new ArgumentNullException(nameof(text)));
	...
	/// </summary>
	public static SqlSource Where(SqlSource sql) => new WhereClauseSql(sql);

	private static JoinSql JoinOrThrow(string separator, IEnumerable<SqlSource> sqls, string throwMessageIfEmpty) =>
